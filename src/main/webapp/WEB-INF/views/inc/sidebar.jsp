...
<div class="col-lg-3">
	<div class="tabs">
		<div class="tab" id="tabstyle1" onclick="openTab('tab1', this)">설치물</div>
		<div class="tab" id="tabstyle2"  onclick="openTab('tab2', this)">하우징</div>
	</div>
		...
		<div class="card mb-4 search-card">
			...
			<div class="card-body"> -->
				<div class="input-group">
					...
					<button type="button" class="btn-search" id="customerSearchModal2" onclick="setHousingList(1)"></button>
				</div>
			<!-- </div> -->
		</div>
		 <!-- Categories widget-->
